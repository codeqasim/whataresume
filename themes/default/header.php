...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo $theme_url;?>/assets/css/accordian-jquery-ui.css">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar11">
                        <ul class="nav navbar-nav navbar-right">
                            <li><a href="<?php echo base_url(); ?>"><img src="<?php echo $theme_url;?>assets/images/home-icon.png" class="home_active_img"></a></li>
                            <li><a href="<?php echo base_url(); ?>about-us">About Us</a></li>
                            <li class="head_top_2 dropdown">
                                <a class="dropdown-toggle11" data-toggle="dropdown11" href="<?php echo base_url(); ?>resume-services">Services<span class="caret"></span></a>
